...
/*
Тут два класса, один Account - он может хранить пароль и имя аккаунта(а в будущем и обрабатывать)
А второй AccManager - он обрабатывает все существующие аккаунты. 
Вообще функционала практическиго так-то нет, но опять же сами технологии программирования, 
    создание свойств класса, описание класса, описание методов класса
    присутствуют.
    
    P.S. Если что-то не так, не ругайтесь, я дурачок, я на самом деле не до конца понял задание... но вроде все верно сделал.
